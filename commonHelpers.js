import{a as $,i as n,S as q}from"./assets/vendor-95dc692e.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const a of t.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function i(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();async function h(o,s){try{const r="https://pixabay.com/api/",i=o.trim().split(",").join("+"),e=new URLSearchParams({key:"42946583-b9bd64904b8b2d582b051d84e",q:i,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:15,page:s}),t=`${r}?${e}`;return(await $.get(t)).data}catch{return n.error({message:"Server error!",position:"topRight"})}}function p(o){const s=o.hits.map(r=>{const{id:i,webformatURL:e,largeImageURL:t,tags:a,likes:w,views:R,comments:S,downloads:P}=r;return`
    ...
    `}).join("");f.insertAdjacentHTML("beforeend",s)}const f=document.querySelector(".gallery"),d=document.querySelector("#search-form"),u=document.querySelector("#load-more-btn"),g=document.querySelector("#loader");let E,y=0,l=1;const B=15,L=new q(".gallery a",{captionsData:"alt",captionPosition:"bottom",captionDelay:250});u.addEventListener("click",M);d.addEventListener("submit",async o=>{o.preventDefault(),f.innerHTML="";const s=o.target.elements.query.value;if(s.trim()==""){n.warning({message:"The search field is empty. Please try again!",position:"topRight"}),m(),d.reset();return}else{try{b();const r=await h(s,l);y=Math.ceil(r.totalHits/B),r.hits.length?(c(),p(r),L.refresh(),v()):(c(),m(),n.error({message:"Sorry, there are no images matching your search query. Please try again.",position:"topRight"}))}catch{c(),n.error({message:"Error render gallery. Please try again!",position:"topRight"})}d.reset()}});async function M(){l+=1,b();try{const o=await h(E,l);p(o),L.refresh(),window.scrollBy({top:578,behavior:"smooth"})}catch{n.error({position:"topRight",message:"ERROR"})}c(),v()}function v(){l>=y?(m(),n.info({message:"We're sorry, there are no more posts to load",position:"topRight"})):O()}function m(){u.classList.add("is-hidden")}function O(){u.classList.remove("is-hidden")}function c(){g.classList.add("is-hidden")}function b(){g.classList.remove("is-hidden")}
